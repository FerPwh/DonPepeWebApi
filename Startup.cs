...
namespace DonPepe
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DonPepe", Version = "v1" });
            });
            services.AddDbContext<DonPepeDBContext>(o => o.UseSqlServer(Configuration.GetConnectionString("DonPepeCS")));
            services.AddCors(c =>
            {
