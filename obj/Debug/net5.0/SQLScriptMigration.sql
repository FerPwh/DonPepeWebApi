...
VALUES (2512, '2021-12-01T13:59:34.0296313-03:00', 1, 493),
(2513, '2021-12-01T13:59:34.0303872-03:00', 2, 374),
(2514, '2021-12-01T13:59:34.0303886-03:00', 1, 200),
(2515, '2021-12-01T13:59:34.0303888-03:00', 3, 607);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'nrofactura', N'fecha', N'idcliente', N'total') AND [object_id] = OBJECT_ID(N'[CabeceraFactura]'))
...
VALUES (N'20211201165934_Init', N'5.0.12');
GO
